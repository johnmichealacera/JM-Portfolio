      ...
      <div v-if="!isLoading" class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh]">
        ...
        <div ref="leftContent" class="space-y-8">
          ...
          <div class="flex flex-col sm:flex-row gap-4 animate-fade-in-up" style="animation-delay: 0.6s;">
            ...
            <!-- Zcal Booking CTA -->
            <a 
              href="https://zcal.co/i/cQemrgBw"
              target="_blank"
              rel="noopener noreferrer"
              class="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 transform hover:-translate-y-1"
            >
              <span class="flex items-center space-x-2">
